...
public class HttpUtil {
	...
	private static ExecutorService defaultExecutor = new ThreadPoolExecutor(40, 100, 120, TimeUnit.SECONDS,
	 ...
	 * @return
	 */
	public static String executePOST(HttpClient client, String reqURL, Map<String, String> params, final int retryTimes,
	 ...
	 * @throws Exception
	 */
	public static String executePOST(HttpClient client, HttpPost httpPost, final int retryTimes,
			HttpClientContext context) throws Exception {
		String responseText = "";
	 ...
	 * @throws Exception
	 */
	public static String executeGet(HttpClient client, String reqURL, final int retryTimes, HttpClientContext context)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	public static String executeGet(HttpClient client, HttpGet httpGet, final int retryTimes, HttpClientContext context)
			throws Exception {
		String responseText = "";
	...
	public static String executeGetISAsBase64(HttpClient client, HttpGet httpGet, final int retryTimes,
			HttpClientContext context, String fileName) throws Exception{
